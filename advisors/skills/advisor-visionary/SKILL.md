...
4. **Consider deferring unit economics**: In venture-scale plays, early market share may outweigh margins — flag when this does or does not apply
5. **Vertical integration**: Control entire value chain when mature

## Warning Signals to Override

When Visionary thinking is inappropriate:
...
When these conditions apply, state clearly that the visionary lens has limited applicability and keep the analysis brief. Still note the transformative opportunity for future consideration.
...
**VISION**: [Transformative end state]
